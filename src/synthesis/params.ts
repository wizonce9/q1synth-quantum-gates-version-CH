...
export const fmParams: Param[] = [
    { type: '调制指数', id: 'modi', min: 0, max: 20, step: 0, values: [0.5, 1], selected: false }, // modi -> 调制
    { type: '谐波比', id: 'harm', min: 0.25, max: 10, step: 0.25, values: [0.25, 1], selected: false }, // harm -> 和声
]
...
export const effectParams = [
    ...
    { type: '失真', id: 'crush', min: 16, max: 4, step: 0, values: [0, 0], selected: false }, // crush -> 压碎
    { type: '声相', id: 'pan', min: -1, max: 1, step: 0, values: [0.5, 0.5], selected: false }, // pan -> 声像
